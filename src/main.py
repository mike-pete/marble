...
from KLWines import KLWineItem, KLWines
from KLWineItemComparison import compare_klwine_items

search_text = "vodka"
kl_wine_data = KLWines(search_text, limit=1).model_dump(by_alias=True)["data"]


for wine_item in kl_wine_data:
